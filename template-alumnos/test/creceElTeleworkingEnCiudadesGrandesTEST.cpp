...
TEST(creceElTeleworkingEnCiudadesGrandesTEST, seMantieneYEn0) {
...
//                                      Estado
//                                           v                                                                 v
    eph_i t1i = {{20957, 2018,   1,  1,  3,  2,  88, 0,  0,  90000,  1},
                 {20957, 2018,   2,  1,  3,  2,  82, 0,  0,  25000,  1},
                 {22866, 2018,   1,  0,  3,  2,  31, 1,  3,  59000,  1},
                 {22866, 2018,   2,  1,  3,  2,  28, 1,  3,  0,      6},
                 {31117, 2018,   3,  0,  3,  2,  46, 1,  3,  17000,  1},
                 {31117, 2018,   4,  0,  3,  2,  20, 1,  3,  5000,   6},
                 {31117, 2018,   5,  0,  3,  2,  15, 0,  0,  5000,   1},
                 {22114, 2018,   1,  0,  3,  2,  18, 0,  0,  20000,  1}};
...
//                                      Estado
//                                           v
    eph_i t2i = {{20957, 2020,   1,  1,  3,  2,  88, 0,  0,  90000,  1},
                 {20957, 2020,   2,  1,  3,  2,  82, 0,  0,  25000,  1},
                 {22866, 2020,   1,  0,  3,  2,  31, 1,  3,  59000,  1},
                 {22866, 2020,   2,  1,  3,  2,  28, 1,  3,  0,      6}, // Esta no: Hotel
                 {31117, 2020,   3,  0,  3,  2,  46, 1,  3,  17000,  1},
                 {31117, 2020,   4,  0,  3,  2,  20, 1,  3,  5000,   6},
                 {31117, 2020,   5,  0,  3,  2,  15, -1,  0,  5000,   6}, // estado no informado
                 {22114, 2020,   1,  0,  3,  2,  18, 0,  0,  20000,  1}};
